        ...
        children: [
          ...
          Scaffold(
            ...
            body: Container(
              ...
              child: Column(
                children: [
                  Text('سورة ${suradetaile.name}', style: Theme
                      .of(context)
                      .textTheme
                      .subtitle1,),
                  Expanded(child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return ayat.isEmpty ? CircularProgressIndicator() : Text(
                        ayat[index], style:Theme.of(context).textTheme.subtitle2,);
                    },))
                ],
              ),
            ),
